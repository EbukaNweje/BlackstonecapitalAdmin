...
const [adminWallet, setAdminWaller] = useState()
  ...
  const getallDeposit = () => {
    const url = "https://blackstonecapital-bank-end.vercel.app/api/getallWalletAddress";
    axios.get(url)
        .then((response) => {
...
const handleDelete = (walletId) => {
  ...
  const url = `https://blackstonecapital-bank-end.vercel.app/api/deleteWalletAddress/${walletId}`;
  axios
      .delete(url)
      .then((res) => {
          console.log(res);
